...
def main():
    ...
    st.sidebar.info("For best results, upload clear images where the animal is the main subject.")
    ...
    # File uploader
    uploaded_file = st.file_uploader("Choose an image (jpg, jpeg, png only)", type=["jpg", "jpeg", "png"])
